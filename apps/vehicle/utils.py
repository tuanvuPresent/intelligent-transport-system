...
rate_direction = [
    [0,0,0,0,0,0,1,1,1,2,2,3,5,6,6,7,7,7],
    [0,0,0,1,1,1,1,1,1,2,2,2,3,3,4,6,7,7],
    [0,0,1,1,1,2,2,2,2,2,2,3,3,3,4,4,5,7],
    [1,1,2,2,2,3,3,3,3,3,3,4,4,4,5,5,6,0],
    [4,4,4,4,4,4,5,5,5,6,6,7,3,3,3,2,2,1],
    [5,5,5,5,5,5,6,6,6,7,7,0,4,4,4,3,3,2],
    [6,6,6,6,6,6,7,7,7,0,0,5,5,5,4,4,3,1],
    [7,7,7,7,7,7,0,0,0,6,6,6,1,1,5,5,4,2],
]
